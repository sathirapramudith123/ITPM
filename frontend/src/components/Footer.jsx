...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-10 mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-blue-100">
              Connecting job seekers and employers with opportunities and talent.
            </p>
            <Link 
              to="/about" 
              className="inline-flex items-center text-blue-100 hover:text-white transition-colors duration-200 mt-2"
            >
              Learn More
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { path: "/resources", label: "Career Resources" },
          ...
          <div>
            ...
            <div className="space-y-3 text-blue-100">
              ...
              <div className="flex items-start">
                ...
                <span>123 Job St, Career City</span>
              </div>
            </div>
          </div>
        </div>
