...
import { createJob, getJobs, getJobById, updateJob, deleteJob, getEmployerJobs, applyForJob } from '../controller/jobController.js';
...
router.post(
  ...
  [
    ...
    check('jobType', 'Job type must be full-time, part-time, or remote').isIn(['full-time', 'part-time', 'remote']),
